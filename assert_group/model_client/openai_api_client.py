"""
Modified from: autogen_ext.models.openai._openai_client.py
Add: extra_body, usage(prompt_tokens_details)
...
from autogen_ext.models.openai._transformation import (
    get_transformer,
)
from autogen_ext.models.openai._utils import assert_valid_name
...
class BaseOpenAIAPIClient(ChatCompletionClient):
    def __init__(
        self,
    ...
    async def create(
        ...
        *,
        ...
        # append_jsonl('tmp_msg.jsonl', {"msg": create_params.messages})
...
class OpenAIAPIClient(BaseOpenAIAPIClient, Component[OpenAIClientConfigurationConfigModel]):
